...
- **TypeScript / TypeSpec** — [`public/packages/typescript/typespec-emitters/`](../../public/packages/typescript/typespec-emitters/README.md) references the proto shapes when generating TypeScript gRPC client stubs
