...
/// + <c>MqSubscriptionsRegistry</c>) into <c>D2.Shared.Messaging.Abstractions</c>
/// from the two spec files. Single-target — only emits when the consuming
/// assembly is <c>D2.Shared.Messaging.Abstractions</c>.
/// </summary>
[Generator]
public sealed class MqGenerator : IIncrementalGenerator
{
    ...
    private const string _TARGET_ASSEMBLY = "D2.Shared.Messaging.Abstractions";
    private const string _ENCRYPTION_DOMAINS_FQN = "D2.Shared.Encryption.EncryptionDomains";
