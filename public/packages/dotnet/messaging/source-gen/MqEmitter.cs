...
{
    private const string _TARGET_NAMESPACE = "D2.Shared.Messaging";
    private const string _PATTERNS_FQN = "D2.Shared.Messaging.QueuePattern";
    ...
    private static void EmitFileHeader(StringBuilder sb)
    {
        ...
        sb.AppendLine(
            "//   Generated by D2.Shared.Messaging.SourceGen from contracts/mq-messages/");
        sb.AppendLine(
