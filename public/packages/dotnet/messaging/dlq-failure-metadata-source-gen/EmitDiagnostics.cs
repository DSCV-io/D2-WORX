...
internal static class EmitDiagnostics
{
    ...
    /// <summary>
    /// Constructs a <see cref="DiagnosticDescriptors.DuplicateFieldConstName"/>
    /// diagnostic.
    /// </summary>
    ...
    /// <summary>
    /// Constructs a <see cref="DiagnosticDescriptors.DuplicateCause"/> diagnostic.
    /// </summary>
    /// <param name="cause">The duplicated cause constName or value.</param>
    /// <returns>A new <see cref="EmitDiagnostic"/>.</returns>
    public static EmitDiagnostic DuplicateCause(string cause) =>
        new(DiagnosticIds.DuplicateCause, [cause]);
