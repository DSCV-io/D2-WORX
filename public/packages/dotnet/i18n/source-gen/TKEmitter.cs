...
internal static class TKEmitter
{
    ...
    private const string _DEFAULT_ROOT_NAMESPACE = "D2.Shared.I18n";
        ...
        string className)
    {
        ...
        sb.AppendLine(
            "/// Each constant is a <see cref=\"global::D2.Shared.I18n.TKMessage\"/> with the JSON key and no params;");
        sb.AppendLine("/// bind parameters via <see cref=\"global::D2.Shared.I18n.TKMessage.With(string, string)\"/>.");
        sb.AppendLine("/// </summary>");
