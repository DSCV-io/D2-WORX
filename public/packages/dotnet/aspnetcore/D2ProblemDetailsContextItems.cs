...
/// <see cref="D2.Shared.Result.D2Result"/> under
...
/// <c>D2.Shared.Auth.Http</c>) and path B byte-identical. <c>Instance</c>
...
public static class D2ProblemDetailsContextItems
{
    ...
    /// originating <see cref="D2.Shared.Result.D2Result"/> failure so the
