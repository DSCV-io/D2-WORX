...
/// <see cref="EmitDiagnostic"/> instances with grpc-trailers-source-gen
/// descriptor IDs (<c>D2GT*</c>). The diagnostic record itself lives in
...
internal static class EmitDiagnostics
{
    ...
    /// <summary>
    /// Constructs a <see cref="DiagnosticDescriptors.EmptyValue"/> diagnostic.
    /// </summary>
