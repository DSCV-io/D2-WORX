...
public partial class D2Result
{
    ...
    /// <param name="traceId">Optional trace identifier.</param>
    /// <returns>A pre-built <see cref="D2Result"/> failure.</returns>
    public static D2Result ValidationFailed(IReadOnlyList<TKMessage>? messages = null, IReadOnlyList<InputError>? inputErrors = null, string? errorCode = null, ErrorCategory? category = null, string? traceId = null)
    {
