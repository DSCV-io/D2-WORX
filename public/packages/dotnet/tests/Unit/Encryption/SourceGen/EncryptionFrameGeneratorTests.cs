// -----------------------------------------------------------------------
// <copyright file="EncryptionFrameGeneratorTests.cs" company="DCSV">
...
/// <summary>
/// IIncrementalGenerator integration tests for the EncryptionFrame SrcGen
/// — drives <see cref="EncryptionFrameGenerator"/> via a synthetic
/// <see cref="CSharpGeneratorDriver"/> rather than the build pipeline.
/// </summary>
public sealed class EncryptionFrameGeneratorTests
{
    ...
    public void Generator_TargetAssemblyWithSpec_EmitsFrameLayoutGeneratedSource()
    {
        ...
        fileName.Should().Be("EncryptionFrameLayout.g.cs");
    }
    ...
    private static GeneratorDriver RunGenerator(string assemblyName, string? specJson)
    {
        ...
        var generator = new EncryptionFrameGenerator().AsSourceGenerator();
