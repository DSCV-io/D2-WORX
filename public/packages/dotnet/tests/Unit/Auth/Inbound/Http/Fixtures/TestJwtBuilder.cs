...
/// <summary>
/// Builds real RSA-signed JWTs for middleware tests. Same shape as the test
/// builder in <c>JwtValidatorTests</c> — duplicated here to avoid fragile
/// nested-private-type access across test classes (per the project's
