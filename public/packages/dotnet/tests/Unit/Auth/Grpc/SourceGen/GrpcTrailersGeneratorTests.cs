// -----------------------------------------------------------------------
// <copyright file="GrpcTrailersGeneratorTests.cs" company="DCSV">
...
/// <summary>
/// IIncrementalGenerator integration tests for the GrpcTrailers SrcGen —
/// drives <see cref="GrpcTrailersGenerator"/> via a synthetic
/// <see cref="CSharpGeneratorDriver"/> rather than the build pipeline.
/// </summary>
public sealed class GrpcTrailersGeneratorTests
{
    ...
    public void Generator_TargetAssemblyWithSpec_EmitsTrailersGeneratedSource()
    {
        ...
        fileName.Should().Be("D2GrpcTrailers.g.cs");
    }
