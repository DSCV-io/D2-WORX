...
namespace D2.Shared.Encryption
{
    partial class EncryptionSourceStartupCheckLog
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Extensions.Logging.Generators", "10.0.14.21808")]
        private static readonly global::System.Action<global::Microsoft.Extensions.Logging.ILogger, global::System.String, global::D2.Shared.Encryption.EncryptionKeyringSource, global::System.Exception?> __StaticSourceInDevelopmentCallback =
            global::Microsoft.Extensions.Logging.LoggerMessage.Define<global::System.String, global::D2.Shared.Encryption.EncryptionKeyringSource>(global::Microsoft.Extensions.Logging.LogLevel.Warning, new global::Microsoft.Extensions.Logging.EventId(2, nameof(StaticSourceInDevelopment)), "Encryption domain {ServiceKey} is backed by a static key source ({Source}). Allowed only because the host is in the Development environment — this configuration would crash a non-Development host.", new global::Microsoft.Extensions.Logging.LogDefineOptions() { SkipEnabledCheck = true }); 

        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Extensions.Logging.Generators", "10.0.14.21808")]
        public static partial void StaticSourceInDevelopment(global::Microsoft.Extensions.Logging.ILogger logger, global::System.String serviceKey, global::D2.Shared.Encryption.EncryptionKeyringSource source)
        {
            if (logger.IsEnabled(global::Microsoft.Extensions.Logging.LogLevel.Warning))
            {
