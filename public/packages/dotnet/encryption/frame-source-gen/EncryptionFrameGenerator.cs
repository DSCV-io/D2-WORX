// -----------------------------------------------------------------------
// <copyright file="EncryptionFrameGenerator.cs" company="DCSV">
...
/// </summary>
[Generator]
public sealed class EncryptionFrameGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(combined, static (spc, tuple) =>
        {
            ...
            var loadResult = EncryptionFrameSpecLoader.Load(spec.Path, spec.Content);
            ...
            var emitResult = EncryptionFrameEmitter.Emit(loadResult.Spec!);
    ...
    private static DiagnosticDescriptor ResolveDescriptor(string id) => id switch
    {
        ...
        DiagnosticIds.DuplicateFieldName => DiagnosticDescriptors.DuplicateFieldName,
        DiagnosticIds.OverlappingFields => DiagnosticDescriptors.OverlappingFields,
        DiagnosticIds.InvalidLength => DiagnosticDescriptors.InvalidLength,
        DiagnosticIds.InvalidVersion => DiagnosticDescriptors.InvalidVersion,
