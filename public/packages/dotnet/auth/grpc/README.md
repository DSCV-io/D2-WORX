...
1. **`RequestOriginCrossProcessInterceptor`** — establishes the [`RequestOrigin.CrossProcessHop`](../abstractions/README.md#requestorigin--callpath--local-establishment-facts-vs-propagated-telemetry) plane on the same scoped `IRequestContext` the auth interceptor populated ([ADR-0025](../../../../../public/docs/adrs/0025-request-context-establishment.md)).
...
`public/packages/dotnet/tests/Unit/Auth/Inbound/Grpc/`:
...
`public/packages/dotnet/tests/Unit/Auth/Inbound/Grpc/Establishment/`:
