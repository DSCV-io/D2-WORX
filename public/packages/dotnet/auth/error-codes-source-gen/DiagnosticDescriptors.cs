...
internal static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor MalformedSpec = new(
        ...
        title: "Auth error codes spec is malformed",
        messageFormat: "Auth error codes spec '{0}' is malformed or schema-violating: {1}",
        category: _CATEGORY,
    ...
    public static readonly DiagnosticDescriptor DuplicateCode = new(
        ...
        title: "Duplicate auth error code",
        messageFormat: "Auth error code '{0}' is declared more than once in the spec",
        category: _CATEGORY,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor DuplicateFactoryName = new(
        ...
        title: "Duplicate auth error code factory name",
        messageFormat:
            "Auth error code factory name '{0}' is declared more than once in the spec",
        category: _CATEGORY,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor InvalidHttpStatus = new(
        ...
        title: "Auth error code httpStatus is not supported by the codegen mapping",
        messageFormat:
