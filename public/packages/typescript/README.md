...
pnpm -r --filter "./public/packages/typescript/**" --filter "./tools/ts-codegen" run build   # builds + runs prebuild codegen
pnpm -r --filter "./public/packages/typescript/**" --filter "./tools/ts-codegen" run test    # runs vitest in every package
```
