...
const GRPC_HOME = join(
  REPO,
  "private/services/edge/tests/Unit/KeyCustodian/TypeSpecGrpc/Generated",
);
...
const GRPC_PROTOS = join(
  REPO,
  "private/services/edge/tests/Unit/KeyCustodian/TypeSpecGrpc/Protos",
);
...
const KC_MAPPER_HOME = join(
  REPO,
  "private/services/edge/api/Mappers/KeyCustodian",
);

/** Production .g.proto files (Edge.Api). */
const KC_PROTO_HOME = join(
  REPO,
  "private/services/edge/api/Protos/KeyCustodian",
);
