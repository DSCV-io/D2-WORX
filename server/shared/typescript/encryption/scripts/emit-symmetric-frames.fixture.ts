...
const OUT_DIR = join(
  REPO_ROOT,
  "server/shared/dotnet/tests/Integration/Encryption/TsCryptoInterop/fixtures",
);
...
async function main(): Promise<void> {
  ...
  const manifest = {
    ...
    emittedBy:
      "server/shared/typescript/encryption/scripts/emit-symmetric-frames.fixture.ts",
