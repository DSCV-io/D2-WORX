...
| Well-known committed fixtures match regen under production routes ns (path still tests home) | byte-gate + deliberate-drift negatives | `tests/keycustodian-wellknown-emit.integration.test.ts` |
