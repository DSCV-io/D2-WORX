...
export interface IAuthContext {
   ...
   */
  readonly requestedByClientId: string | null;
  /**
   ...
   */
  readonly immediateCallerClientId: string | null;
  /**
   ...
   */
  readonly originatingClientId: string | null;
  /**
   ...
   */
  readonly isServiceIdentity: boolean | null;
  // --- Organization ---
  /**
   ...
   */
  readonly impersonatorOrgType: OrgType | null;
  /**
   ...
   */
  readonly impersonatorOrgRole: Role | null;
  // --- Scopes ---
  /**
