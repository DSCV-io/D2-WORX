...
| [`validation/abstractions/`](validation/abstractions/README.md)         | **Built** | Cross-language input-validation contracts — `IEmailValidator`, `IPhoneValidator`, `IPostalCodeValidator` (country-aware). Each returns `D2Result<string>` (normalized value on success; per-field `InputError` keyed with the `common_validation_*_INVALID` translation key on failure). Pure interfaces — no libphonenumber, no postcode dataset.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `D2.Shared.Validation.Abstractions`                                                                                            |
