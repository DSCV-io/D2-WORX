## API Report File for "@d2/auth-abstractions"
...
export const Scopes: {
    readonly anon: {
        readonly auth: {
            readonly signin: {
                readonly attempt: "anon.auth.signin.attempt";
            };
        };
        readonly public: {
    ...
    readonly auth: {
        readonly password: {
            readonly change: "auth.password.change";
        };
        readonly user: {
            readonly impersonate: {
                readonly consent: "auth.user.impersonate.consent";
                readonly force: "auth.user.impersonate.force";
            };
        };
    };
    readonly billing: {
