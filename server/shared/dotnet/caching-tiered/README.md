...
Two-tier cache that composes one [`ILocalCache`](../caching-abstractions/README.md) (L1) and one
[`IDistributedCache`](../caching-abstractions/README.md) (L2) into the
[`ITieredCache`](../caching-abstractions/README.md) marker interface.
...
- [`caching-abstractions/README.md`](../caching-abstractions/README.md) — interface + result-mapping
  reference
- [`caching-local-default/README.md`](../caching-local-default/README.md) — typical L1 impl
- [`caching-distributed-redis/README.md`](../caching-distributed-redis/README.md) — typical L2 impl
