...
internal static class RecordShapeEmitter
{
    ...
    private static EmitResult EmitMeasurementSystemEnum()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Mixed (UK: miles for roads, Celsius for weather, kg for groceries).</summary>");
    ...
    private static EmitResult EmitCountry()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Native-script short name (e.g. \"日本\" for JP).</summary>");
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>E.164 calling code (e.g. \"1\", \"44\", \"81\").</summary>");
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Minimum subscriber-number digit count; null for territories lacking subscriber data.</summary>");
    ...
    private static EmitResult EmitSubdivision()
    {
        ...
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>ISO 3166-2 typed subdivision identifier (PK, e.g. \"US-CA\").</summary>");
        sb.AppendLine("    public required SubdivisionCode Iso31662Code { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Country-local short identifier (segment after the hyphen).</summary>");
        ...
        sb.AppendLine("    public required string OfficialName { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Native-script display name (e.g. \"Bayern\" for DE-BY).</summary>");
        sb.AppendLine("    public required string EndonymDisplayName { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Native-script official name.</summary>");
        sb.AppendLine("    public required string EndonymOfficialName { get; init; }");
    ...
    private static EmitResult EmitCurrency()
    {
        ...
        sb.AppendLine($"namespace {_NAMESPACE};");
        sb.AppendLine();
        sb.AppendLine("/// <summary>Currency record — formatting metadata + supported flag + reverse-nav to accepting countries.</summary>");
        sb.AppendLine("public sealed record Currency");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>Typed ISO 4217 alpha identifier (PK, e.g. <c>CurrencyCode.USD</c>).</summary>");
        sb.AppendLine("    public required CurrencyCode Iso4217AlphaCode { get; init; }");
        sb.AppendLine();
        ...
        sb.AppendLine("    public required string OfficialName { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Fractional-unit digit count (0 = JPY; 2 = USD; 3 = BHD).</summary>");
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>True when the framework treats this currency as user-selectable.</summary>");
    ...
    private static EmitResult EmitLanguage()
    {
        ...
        sb.AppendLine($"namespace {_NAMESPACE};");
        sb.AppendLine();
        sb.AppendLine("/// <summary>Language record — endonym + writing direction + supported flag + reverse navs to countries / locales.</summary>");
        sb.AppendLine("public sealed record Language");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>Typed ISO 639-1 identifier (PK, e.g. <c>LanguageCode.En</c>).</summary>");
        ...
        sb.AppendLine("    public required string DisplayName { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Native-script language name (e.g. \"日本語\" for ja).</summary>");
    ...
    private static EmitResult EmitLocale()
    {
        ...
        sb.AppendLine($"namespace {_NAMESPACE};");
        sb.AppendLine();
        sb.AppendLine("/// <summary>Locale record — formatting metadata + recursive language/country nav.</summary>");
        sb.AppendLine("public sealed record Locale");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>Typed IETF BCP 47 locale identifier (PK, e.g. <c>\"en-US\"</c>).</summary>");
        ...
        sb.AppendLine("    public Country? Country { get; internal set; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>True when a matching contracts/messages/{tag}.json file exists.</summary>");
        sb.AppendLine("    public required bool IsSelectable { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Calendar first day of the week per CLDR.</summary>");
        sb.AppendLine("    public required GeoDayOfWeek FirstDayOfWeek { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Single-character decimal separator (e.g. \".\" or \",\").</summary>");
        sb.AppendLine("    public required string DecimalSeparator { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Thousands separator (zero or one char — some locales lack one).</summary>");
        sb.AppendLine("    public required string ThousandsSeparator { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Date-component ordering for the human-readable form.</summary>");
    ...
    private static EmitResult EmitTimezone()
    {
        ...
        sb.AppendLine($"namespace {_NAMESPACE};");
        sb.AppendLine();
        sb.AppendLine("/// <summary>Timezone record — offsets + abbreviations + localized names + aliases + country navs.</summary>");
        sb.AppendLine("public sealed record Timezone");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>Typed IANA timezone identifier (PK, e.g. <c>\"America/New_York\"</c>).</summary>");
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Standard-time offset from UTC in minutes (e.g. -300 for EST).</summary>");
        sb.AppendLine("    public required int CurrentStdOffsetMinutes { get; init; }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>Daylight-saving offset from UTC in minutes; null for zones without DST.</summary>");
    ...
    private static EmitResult EmitGeopoliticalEntity()
    {
        ...
        sb.AppendLine($"namespace {_NAMESPACE};");
        sb.AppendLine();
        sb.AppendLine("/// <summary>GeopoliticalEntity record — member countries with O(1) <c>Contains</c> over the typed code set.</summary>");
        sb.AppendLine("public sealed record GeopoliticalEntity");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>Typed identifier (PK, e.g. <c>\"NATO\"</c>, <c>\"EU\"</c>).</summary>");
