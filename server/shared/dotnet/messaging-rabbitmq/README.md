...
[`messaging-source-gen/README.md`](../messaging-source-gen/README.md). The
transport-agnostic public surface (`IMessageBus`, `[MqPub]`, `[MqSub]`,
descriptor records) lives in
[`messaging-abstractions/README.md`](../messaging-abstractions/README.md).
...
- [`messaging-source-gen/`](../messaging-source-gen/README.md) — codegen
...
- [`encryption/`](../encryption/README.md) — encryption primitive (keyring,
