...
/// Mirrors the TS-side sealed catalog in <c>@d2/encryption-abstractions</c>
...
internal static class SealedFrameEmitter
{
        ...
        int version, List<EncryptionFrameField> entries, SealedFrameConstraints c)
    {
        ...
        sb.AppendLine(
            "//   Generated by D2.Shared.EncryptionFrame.SourceGen.SealedFrameGenerator");
        sb.AppendLine(
        ...
        sb.AppendLine(
            "/// reader ships out of @d2/encryption-abstractions from the same spec.");
        sb.AppendLine("/// </summary>");
