...
/// <see cref="ErrorCodesGenerator"/>. Kept in a separate class from
/// <see cref="DiagnosticDescriptors"/> so non-Roslyn-host consumers
/// (e.g. unit tests of the pure-logic <see cref="ErrorCodesEmitter"/> /
/// <see cref="ErrorCodesSpecLoader"/>) can reference the IDs without
