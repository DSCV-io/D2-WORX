...
/// <summary>
/// A diagnostic produced by <see cref="ScopeSpecLoader"/> or
/// <see cref="ScopesEmitter"/>. Decoupled from
...
/// <see cref="ScopesGenerator.Initialize"/> translates these to real Roslyn
/// <c>Diagnostic</c> instances.
/// </summary>
/// <param name="DescriptorId">
/// Matches a <see cref="DiagnosticIds"/> identifier (e.g. <c>"D2SCP001"</c>).
/// </param>
/// <param name="Args">
