...
internal static class ScopesEmitter
{
        ...
        IReadOnlyList<string> roleNames)
    {
        ...
        var source = EmitSource(tree, validScopes, orgTypeNames, roleNames);
        ...
        IReadOnlyList<string> roleNames)
    {
        ...
        sb.AppendLine("//   Generated by D2.Shared.Auth.Scopes.SourceGen.ScopesGenerator");
        ...
        sb.AppendLine(
            ...
            + "dot-separated path");
        sb.AppendLine("/// (e.g. <c>Scopes.Auth.User.Impersonate.Force</c>).");
        sb.AppendLine("/// </summary>");
        sb.AppendLine($"public static partial class {_SCOPES_CLASS_NAME}");
        sb.AppendLine("{");
