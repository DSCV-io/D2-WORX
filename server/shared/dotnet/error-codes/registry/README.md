...
The TS side mirrors this exactly: `@d2/error-codes-registry` is generated from the same spec set by `tools/ts-codegen/src/error-codes-registry-emit.ts`. Cross-runtime parity enforced by `server/shared/typescript/contract-tests/tests/error-codes-registry.parity.test.ts`.
