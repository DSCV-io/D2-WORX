...
Redis-backed implementation of [`IDistributedCache`](../caching-abstractions/README.md) and
[`ICacheInvalidationBackplane`](../caching-abstractions/README.md). Wraps `StackExchange.Redis`.
