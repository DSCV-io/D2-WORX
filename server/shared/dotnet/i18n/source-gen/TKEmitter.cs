...
internal static class TKEmitter
{
    ...
    private const string _ROOT_NAMESPACE = "D2.Shared.I18n";
    private const string _TK_CLASS_NAME = "TK";
            ...
            byPath)
    {
        ...
        sb.AppendLine("//   Generated by D2.Shared.I18n.SourceGen.TKGenerator");
        ...
        sb.AppendLine("/// bind parameters via <see cref=\"TKMessage.With(string, string)\"/>.");
        sb.AppendLine("/// </summary>");
        ...
        int indent)
    {
        ...
        foreach (var constantKvp in constants)
        {
            ...
            sb.AppendLine($"{pad}    /// </summary>");
            sb.AppendLine(
                $"{pad}    public static readonly global::D2.Shared.I18n.TKMessage " +
