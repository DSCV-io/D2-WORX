...
internal static class FieldConstraintsEmitter
{
    ...
    public const string ROOT_NAMESPACE = "D2.Shared.Validation.Abstractions";
    ...
    private static string BuildConstraintsSource(List<ConstraintEntry> entries)
    {
        ...
        sb.AppendLine(
            "/// constants and the TS-side @d2/validation-abstractions catalog is");
        sb.AppendLine(
    ...
    private static void AppendHeader(StringBuilder sb)
    {
        ...
        sb.AppendLine("//   Generated by D2.Shared.Validation.SourceGen");
        sb.AppendLine(
