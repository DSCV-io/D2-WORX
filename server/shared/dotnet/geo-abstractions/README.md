...
The dispatch fires on `compilation.AssemblyName` so the analyzer reaches both consumer assemblies from a single project reference each. See [`../geo-source-gen/README.md`](../geo-source-gen/README.md) for the full multi-assembly dispatch design.
