...
public sealed class TKMessageTests
{
    ...
    {
        // Adversarial: every SrcGen-emitted constant ships with null Parameters —
    ...
    {
        // Static readonly — referencing TK.X.Y.Z twice returns the same object.
    ...
    // ----------------------------------------------------------------------
    // With(name, value) — bind a single parameter
    // ----------------------------------------------------------------------
    ...
    public void With_DoesNotMutateReceiver()
    {
        ...
        // Receiver immutability is the entire point of the static-readonly TK pattern —
    ...
    // ----------------------------------------------------------------------
    // With(IReadOnlyDictionary<string, string>) — replace whole dict
    // ----------------------------------------------------------------------
    ...
    // ----------------------------------------------------------------------
    // Equality — record-style with order-independent params
    // ----------------------------------------------------------------------
    ...
    public void Equality_OneNullOneEmptyParams_AreNotEqual()
    {
        ...
        // null → no "params" key; empty → no "params" key on Write (per converter).
