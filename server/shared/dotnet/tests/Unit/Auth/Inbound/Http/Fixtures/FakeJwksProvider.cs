...
/// <summary>
/// In-memory <see cref="IJwksProvider"/> stand-in that returns a snapshot built
/// from canned <see cref="SecurityKey"/>s. Independent from the JwtValidator
/// test's nested fake — each test class owns its fixtures (per project
/// convention).
/// </summary>
