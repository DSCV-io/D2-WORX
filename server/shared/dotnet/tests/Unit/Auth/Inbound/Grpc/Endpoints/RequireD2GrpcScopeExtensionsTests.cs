...
public sealed class RequireD2GrpcScopeExtensionsTests
{
    ...
    public void AllowD2Anonymous_AttachesAnonymousSingleton()
    {
        ...
        var meta = ApplyAndExtract(builder);
        meta.Should().BeSameAs(MethodScopeMetadata.Anonymous);
    }
    ...
    private static MethodScopeMetadata? ApplyAndExtract(TestEndpointConventionBuilder builder)
    {
        ...
        return endpointBuilder.Metadata.OfType<MethodScopeMetadata>().FirstOrDefault();
    }
