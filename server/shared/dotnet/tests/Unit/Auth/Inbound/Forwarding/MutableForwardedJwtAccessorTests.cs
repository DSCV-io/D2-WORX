...
/// </summary>
/// <remarks>
/// In this step the holder is POPULATED by the inbound auth surface but has no
/// production READER yet (the outbound forwarding credential consumes it in a
/// later step). These tests therefore prove the holder STANDALONE via a
/// populate-then-read-back cycle: the test plays the role of the future
