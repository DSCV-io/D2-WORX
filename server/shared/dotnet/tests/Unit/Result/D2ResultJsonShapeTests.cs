...
///     wire — they're <c>[JsonIgnore]</c>'d.</item>
...
public sealed class D2ResultJsonShapeTests
{
    ...
    public void Serialize_DoesNotLeakIsBooleanHelpers()
    {
        ...
        // carrying IsOk / IsNotFound / IsCanceled / etc. — they're
        ...
        var leakedHelpers = new[]
        {
            ...
            "IsIdempotencyInFlight", "isIdempotencyInFlight",
            "IsPartialOrMissing", "isPartialOrMissing",
            "IsTransientRetryable", "isTransientRetryable",
            "Failed", "failed",
        };
    ...
    public void Serialize_IsImmuneToDefaultOptions()
    {
        ...
        // options — confirms the envelope wire shape is per-property
    ...
    public void Serialize_WireKeysSubsetOfCatalog()
    {
        ...
        // the D2ResultEnvelopeFieldNames catalog — pins against accidental
