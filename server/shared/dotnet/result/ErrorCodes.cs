...
/// <see cref="D2Result.ErrorCode"/>. Consumers may compare against these constants
/// (or use the per-code boolean helpers on <see cref="D2Result"/>) to discriminate
/// between known failure modes.
/// </summary>
public static class ErrorCodes
{
    ...
    /// <summary>
    /// Indicates that the user is unauthorized to perform the action
