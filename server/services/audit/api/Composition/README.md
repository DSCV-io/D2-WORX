...
**Honest A rails:** AuthConfigure ON, MutualTls `AllowedWorkloads=["edge"]` + public TrustAnchors, `AddD2RequestOriginGrpc(ServiceId=audit)`, Redis `ParseRedisUri` + backplane + tiered cache. No JWT minter.
