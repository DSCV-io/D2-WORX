// -----------------------------------------------------------------------
// <copyright file="SmokeTester.cs" company="DCSV">
...
/// <summary>
/// Default <see cref="ISmokeTester"/>: exercises freshly-generated (or
/// freshly-unwrapped) key material to prove it is cryptographically usable
/// before the key is activated.
/// </summary>
/// <remarks>
...
/// </list>
/// </remarks>
public sealed class SmokeTester : ISmokeTester
{
