// -----------------------------------------------------------------------
// <copyright file="ActivateKey.cs" company="DCSV">
...
/// </remarks>
public sealed class ActivateKey(
    HandlerContext<ActivateKey> ctx,
    ...
    IClock clock)
    : BaseRepoHandler<ActivateKey, ActivateKeyInput, KeySummary>(ctx, classifier), IActivateKey
{
    /// <inheritdoc/>
