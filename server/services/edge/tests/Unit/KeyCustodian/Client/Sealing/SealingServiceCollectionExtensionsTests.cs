...
public sealed class SealingServiceCollectionExtensionsTests
{
    ...
    public void ViaKeyCustodian_WiresKeyedSealer_PerDistinctConsumerService()
    {
        ...
        foreach (var consumer in EncryptionDomainModes.ConsumerServiceByDomain.Values.Distinct())
    ...
    public void ViaKeyCustodian_ConsumerHost_WiresSelfOpener()
    {
        ...
        var ownConsumer = EncryptionDomainModes.ConsumerServiceByDomain.Values.First();
        var sp = new ServiceCollection()
        ...
        foreach (var other in EncryptionDomainModes.ConsumerServiceByDomain.Values
                     .Distinct()
                     .Where(c => c != ownConsumer))
        {
