...
/// <summary>
/// Service-key constants for the <c>PlaceOrderV2</c> gRPC client resilience pipeline.
/// </summary>
public static class PlaceOrderV2ClientKeys
{
    /// <summary>DI service key for the keyed <c>ResilientPipeline&lt;TKey, TValue&gt;</c> registration.</summary>
    public const string PIPELINE = "PlaceOrderV2GrpcClientPipeline";
    ...
    /// </summary>
    internal const string PIPELINE_KEY = "PlaceOrderV2GrpcClientCall";
}
