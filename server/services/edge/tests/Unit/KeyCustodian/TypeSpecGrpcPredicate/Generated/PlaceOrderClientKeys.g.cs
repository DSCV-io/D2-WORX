...
/// <summary>
/// Service-key constants for the <c>PlaceOrder</c> gRPC client resilience pipeline.
/// </summary>
public static class PlaceOrderClientKeys
{
    /// <summary>DI service key for the keyed <c>ResilientPipeline&lt;TKey, TValue&gt;</c> registration.</summary>
    public const string PIPELINE = "PlaceOrderGrpcClientPipeline";
    ...
    /// </summary>
    internal const string PIPELINE_KEY = "PlaceOrderGrpcClientCall";
}
