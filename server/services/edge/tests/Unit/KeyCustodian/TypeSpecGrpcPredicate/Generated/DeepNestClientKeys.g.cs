...
/// <summary>
/// Service-key constants for the <c>DeepNest</c> gRPC client resilience pipeline.
/// </summary>
public static class DeepNestClientKeys
{
    /// <summary>DI service key for the keyed <c>ResilientPipeline&lt;TKey, TValue&gt;</c> registration.</summary>
    public const string PIPELINE = "DeepNestGrpcClientPipeline";
    ...
    /// </summary>
    internal const string PIPELINE_KEY = "DeepNestGrpcClientCall";
}
