...
>
> **Model per [rules.md §24.0i](docs/dev/rules/24-audit-evidence-discipline-meta-how-to-audit.md#24-audit-evidence-discipline-meta--how-to-audit)**: Planner / Plan-amender / Aggregator / Orchestrator → **Fable 5**; Implementer / Auditor / Plan-Auditor / Fixer / Final-reviewer / Investigator → **Opus 4.8**. Sweeping Implementer / Fixer Fable carve-out (atomic >40-file / >3-concern / cross-runtime / cascading pipeline — cite the criterion) + Auditor-shape Fable escalation (per-occurrence user approval) → §24.0i.
>
...
- **Sub-agent model policy** ([rules.md §24.0i](docs/dev/rules/24-audit-evidence-discipline-meta-how-to-audit.md#24-audit-evidence-discipline-meta--how-to-audit)): Auditor / Plan-Auditor / Final-reviewer / Implementer / Fixer / Investigator → Opus; Planner / Plan-amender / Aggregator / Orchestrator → Fable. Sweeping Implementer / Fixer Fable carve-out per the four §24.0i criteria (atomic >40-file / >3-concern / cross-runtime / cascading pipeline) — cite the criterion + self-attest; Auditor-shape Fable escalation needs per-occurrence user approval ([§13.14](docs/dev/rules/13-permission-action-discipline.md#13-permission--action-discipline)). Table + trust-but-verify → [process.md §3](docs/dev/process.md#sub-agent-model-policy-per-role) + [§4](docs/dev/process.md#orchestrator-verification-of-sub-agent-outputs).
