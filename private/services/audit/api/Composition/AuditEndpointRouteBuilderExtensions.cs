...
/// <summary>
/// Audit endpoint mapping â€” <see cref="MapD2AuditEndpoints"/>.
/// </summary>
public static class AuditEndpointRouteBuilderExtensions
{
    ...
    extension(IEndpointRouteBuilder endpoints)
    {
        ...
        /// (<see cref="ProductScopes.Internal.Audit.Ping"/>) <strong>only on the mTLS
        /// listen</strong> (<see cref="AuditHttpsRolePolicies.MTLS_HTTPS_PORT"/>).
        /// No public REST product surface â€” public HTTP for PingAudit lives on
        ...
        public IEndpointRouteBuilder MapD2AuditEndpoints()
        {
            ...
            // infrastructure health/metrics only â€” no product gRPC Maps.
    ...
    {
        // Multiproc S2S business op â€” dual-factor JWT scope + mTLS.
        ...
        if (endpoints is not IApplicationBuilder app)
        {
            throw new InvalidOperationException(
                "MapD2AuditEndpoints requires an IApplicationBuilder (WebApplication) "
                    ...
                    + "UseEndpoints(e => e.MapD2AuditEndpoints()) is not supported â€” "
