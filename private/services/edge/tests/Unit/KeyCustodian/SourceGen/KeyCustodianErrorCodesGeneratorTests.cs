...
/// KeyCustodianErrorCodes SrcGen ΓÇö drive
...
public sealed class KeyCustodianErrorCodesGeneratorTests
{
    ...
    {
        // No AdditionalText supplied â€” generator silently no-ops (no spec).
    ...
    {
        // 599 is not in the engine's supported status set â†’ D2KEC005.
        const string spec = """
        {
          "errorCodes": [
            {
    ...
    public void Generator_RemovedFactoryShape_FiresUnsupportedFactoryShape()
    {
        ...
        // â€” the non-vacuous proof that standard (not the removed shapes) is the
        // correct KC shape.
        const string spec = """
        {
          "errorCodes": [
