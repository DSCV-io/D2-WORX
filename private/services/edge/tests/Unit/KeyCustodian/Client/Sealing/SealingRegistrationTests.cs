...
public sealed class SealingRegistrationTests
{
    ...
    public void FromKeyCustodian_InProcessTwin_WiresSealerArmsOnly_NeverAnOpener()
    {
        ...
        services.AddD2SealedEncryptionFromKeyCustodian(
            ownServiceId: "audit", callingModuleId: "edge");
    ...
    private static ServiceProvider BuildViaProvider(
        string ownServiceId, ISealingClient? fake = null)
    {
        var services = NewServices();
