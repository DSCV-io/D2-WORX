...
/// scoped request-context â€” <see cref="RequestOrigin.InProcessModule"/>,
/// <c>ImmediateCaller = callingModuleId</c>, the <c>internal.kc.seal.encrypt</c> scope â€” then
...
/// structurally unsupported here (decrypt is CrossProcessHop-only â€” a co-hosted module never
...
/// guessing â€” fail-closed: the host names itself).
/// </remarks>
internal sealed class InProcessSealingClient : ISealingClient
{
    /// <summary>
    /// The in-host module being entered â€” KeyCustodian owns the sealing surface.
    /// </summary>
    ...
    /// <inheritdoc />
    /// <remarks>
    /// Structurally unsupported: no in-process OPENER source exists anywhere â€” sealed
