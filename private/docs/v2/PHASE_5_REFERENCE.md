...
- [ ] D2.Courier client library (`private/services/courier/clients/dotnet/`) ships with the Universal Message Shape preserved
- [ ] D2.Notifications service ships with the schema + pipeline above
- [ ] D2.Courier service ships embodying the 6 design principles
- [ ] Per-service READMEs (`private/services/courier/README.md`, `private/services/notifications/README.md`) capture the Phase 5 details
