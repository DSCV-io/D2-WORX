...
- [ ] DefaultOptions log-suppression pattern documented in `private/services/files/clients/dotnet/README.md`
- [ ] SeaweedFS integration shipped (replacing MinIO for user files)
- [ ] Per-service README (`private/services/files/README.md`) captures the Phase 6 details
