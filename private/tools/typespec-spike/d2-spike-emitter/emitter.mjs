...
// a stable code (`@dcsv-io/d2-spike-emitter/unknown-resilience-profile`) and a formatted
// message, exactly like a first-party emitter would report a spec error.
const $lib = createTypeSpecLibrary({
  name: "@dcsv-io/d2-spike-emitter",
  diagnostics: {
...
export async function $onEmit(context) {
  ...
  // emitterOutputDir is <spike>/generated/@dcsv-io/d2-spike-emitter. The .NET projects
  ...
  if (!pushOp) {
    ...
    const proto = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push.tsp. DO NOT EDIT.
syntax = "proto3";
...
`;
    ...
    const sseEmit = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push.tsp. DO NOT EDIT.
#nullable enable
...
`;
    ...
    const respCtor =
      respMap.fields.length === 1 && respMap.fields[0].scalarName === "boolean"
        ...
        : `new ${respTypeName}()`;
    const edgeReceiver = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push.tsp. DO NOT EDIT.
#nullable enable
using System.Threading.Tasks;
using Grpc.Core;
using ${csNamespace};
...
`;
    ...
    const wiring = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push.tsp. DO NOT EDIT.
#nullable enable
...
`;
    ...
    if (inProcess) {
      ...
      const ipPayload = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push-inproc.tsp. DO NOT EDIT.
#nullable enable
namespace ${ipNs};
...
`;
      ...
      const ipSink = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push-inproc.tsp. DO NOT EDIT.
#nullable enable
using System.Threading;
using System.Threading.Tasks;
...
`;
      ...
      const ipInvoker = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push-inproc.tsp. DO NOT EDIT.
#nullable enable
using System.Threading;
using System.Threading.Tasks;
...
`;
      ...
      const ipWiring = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from push-inproc.tsp. DO NOT EDIT.
#nullable enable
using Microsoft.Extensions.DependencyInjection;
...
`;
  ...
  // `D2Result<T>` from DcsvIo.D2 — noted in the verdict. If key derivation for
  ...
  if (!idempotentOp) {
    ...
    // DcsvIo.D2 reference. C3's "typed failure" is Outcome<T>.Fail(reason).
    const outcomeCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from idempotent.tsp. DO NOT EDIT.
...
// of a DcsvIo.D2 reference while still proving C3's typed-failure posture.
#nullable enable
namespace ${ns};
...
`;
    ...
    const storeCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from idempotent.tsp. DO NOT EDIT.
...
`;
    ...
    const inputCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from idempotent.tsp. DO NOT EDIT.
#nullable enable
namespace ${ns};
...
`;
    ...
    const outputCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from idempotent.tsp. DO NOT EDIT.
#nullable enable
namespace ${ns};
...
`;
    ...
    const handlerCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from idempotent.tsp. DO NOT EDIT.
...
${derivedResolved.map((d) => `                ${d.render},`).join("\n")}
    ...
    const gateCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from idempotent.tsp. DO NOT EDIT.
...
`;
    ...
    const wiringCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from idempotent.tsp. DO NOT EDIT.
...
`;
    ...
    c = {
      ...
      d2ResultNote:
        ...
        "emitter would return D2Result<T> from DcsvIo.D2 (semantic factories) — the gate shape " +
  ...
  // here, `DcsvIo.D2.Resilience` in prod (noted in the verdict, like Spike C's
  ...
  if (!resilienceOp) {
    ...
    if (!allResolved) {
      ...
      // Spike C so it compiles with no DcsvIo.D2 reference.
      const outcomeCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
// MINIMAL D2Result STAND-IN (spike isolation). The real emitter targets
// D2Result<T> from DcsvIo.D2; here a tiny Ok/Fail outcome keeps the spike free
...
`;
      ...
      // onto DcsvIo.D2.Resilience's policy + builder types.
      const abstractionCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
...
`;
    ...
    public static class ${toProfilePascal(p.name)}
    {
        ...
        .join("\n\n");
      const profilesCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
...
`;
      ...
      const inputCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
#nullable enable
namespace ${ns};
...
`;
      ...
      const outputCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
#nullable enable
namespace ${ns};
...
`;
      ...
      const dependencyCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
...
`;
      ...
      const pipelineCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
...
`;
      ...
      // the same exception type (prod: DcsvIo.D2.Resilience's equivalent).
      const brokenCircuitCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
...
`;
      ...
      // stand-in factory for one backed by DcsvIo.D2.Resilience with no pipeline
      // change.
      const wiringCs = `// <auto-generated> — emitted by @dcsv-io/d2-spike-emitter from resilience.tsp. DO NOT EDIT.
...
`;
    ...
    b = {
      ...
      profileRegistryShape:
        "A named map (emitter-owned, exported from @dcsv-io/d2-typespec-decorators): " +
      ...
      b3_registryResolution: {
        ...
        claim:
          ...
          "diagnostic (@dcsv-io/d2-spike-emitter/unknown-resilience-profile) so `tsp compile` exits " +
      ...
      b4_targetsAbstraction: {
        ...
        claim:
          ...
          "site. The chassis supplies the concrete primitives (stand-in here; DcsvIo.D2.Resilience " +
      ...
      d2ResultNote:
        ...
        "D2Result<T> and target DcsvIo.D2.Resilience's policy + builder types — the pipeline shape " +
