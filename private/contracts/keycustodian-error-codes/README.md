...
- [ADR-0025](../../public/docs/adrs/0025-request-context-establishment.md) — the `RequestOrigin` establishment model behind the `REQUEST_ORIGIN_UNESTABLISHED` / `MINTER_CAPABILITY_REQUIRED` denials.
