...
| `d2result-envelope-emit.ts`    | `contracts/d2result-envelope/*.spec.json`                                                   | `@d2/result` (`D2ResultEnvelopeFieldNames` — `success` / `data` / `messages` / `inputErrors` / `errorCode` / `traceId` / `statusCode` / `category` JSON keys; mirrors .NET byte-for-byte for the BFF gateway parser).                                                                                                                                                                                                                                                                                                                                                                                                         |
