...
PHASE_VERBIAGE_OK_PATHS='^(docs/v2/|tools/scripts/audit-lint\.sh$|.*MEMORY\.md$|CHANGELOG\.md$)'
...
# =====================================================================
section "Phase/stage verbiage must stay inside docs/v2/ tracking docs"
...
if [ -n "$verbiage_hits" ]; then
  ...
  note "phase tracking lives in docs/v2/; keep docs describe current reality"
fi
