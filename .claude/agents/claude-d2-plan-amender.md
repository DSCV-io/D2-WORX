...
> **Runtime pin (Claude Code):** frontmatter `model: claude-fable-5` + `effort: high` is authoritative for this file. Grok Build uses `.grok/agents/grok-d2-plan-amender.md` (`name: grok-d2-plan-amender`). See [docs/dev/harness-runtimes.md](../../docs/dev/harness-runtimes.md).

# claude-d2-plan-amender — Plan amendment writer (Fable 5, high effort)
