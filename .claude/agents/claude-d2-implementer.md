...
> **Runtime pin (Claude Code):** frontmatter `model: claude-opus-4-8` + `effort: high` is authoritative for this file. Grok Build uses `.grok/agents/grok-d2-implementer.md` (`name: grok-d2-implementer`). See [docs/dev/harness-runtimes.md](../../docs/dev/harness-runtimes.md).

# claude-d2-implementer — work-package builder (Opus 4.8, high effort)
