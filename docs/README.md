...
| [public ADRs](../public/docs/adrs/README.md) · [private ADRs](../private/docs/adrs/README.md) | Architectural Decision Records (Nygard format + Deliverable cross-link field). Dual-home: framework ADRs under `public/docs/adrs/` (incl. [ADR-0026](../public/docs/adrs/0026-public-private-monorepo-layout.md) layout); product/host ADRs under `private/docs/adrs/`. |
| [dev/human-cutover-oss-public-private.md](dev/human-cutover-oss-public-private.md) | Operator H0–H9 remote cutover (`d2-public` / `d2-private-worx`). Agents do not create remotes. |
