...
- **The fringe stays hand-written.** Form-encoded, well-known JSON, multipart, the SSE binding, and arbitrary-shape endpoints remain hand-authored and documented — named and non-growing, but real.
