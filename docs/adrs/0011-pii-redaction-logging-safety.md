...
- `server/shared/dotnet/utilities/Attributes/RedactDataAttribute.cs`; `server/shared/dotnet/utilities/Diagnostics/SanitizedExceptionRender.cs`.
- `server/shared/dotnet/logging/Destructuring/RedactDataDestructuringPolicy.cs` + `TypeRedactionInfo.cs`; `server/shared/dotnet/logging/Internal/D2RequestContextEnricher.cs`; `server/shared/dotnet/logging/README.md` (LOG-OK / NOT-LOGGED tables).
- `server/shared/dotnet/handler/core/BaseHandler.Logging.cs` (no-`Exception` delegates); `server/shared/dotnet/tests/Unit/Handler/HandlerLogDelegateContractTests.cs`; `server/shared/dotnet/tests/Integration/Logging/RequestContextEnricherIntegrationTests.cs`.
- `server/shared/typescript/logging/src/sanitized-error-render.ts` + README.
