...
The `tools/release-runner` default path (`diff-runner.ts:runDiffRelease`) derives each package's bump from a **build-free artifact diff**, not from commit footers. The diff has two inputs:
