...
24. [Audit Evidence Discipline (meta — how to audit)](#24-audit-evidence-discipline-meta--how-to-audit)
    ...
    - [Predicates §24.0 – §24.23 (incl. §24.0h K=1 carve-out, §24.0i Sonnet-for-Auditors, §24.16 Plan-Audit-required, §24.19 uncommitted-deliverable working-tree, §24.20 tool-invisible convention lens, §24.21 full-solution gate-verify, §24.22 source-xmldoc step-ref scan, §24.23 Fixer no-workspace-IDs in own additions)](#predicates--24-audit-evidence-discipline)
...
- **24.12 (self-audit compliance)** Does the sweep that walks rules.md INCLUDE walking §24 itself against the journal it writes into? In other words, does the latest big table have rows for §24.0, §24.0a-i, §24.1-§24.23 (incl. §24.13.1-4 and §24.13.3a-d) — each one PASS-cited or FINDING'd against the journal file itself?
