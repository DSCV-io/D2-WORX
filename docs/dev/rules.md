...
- **24.12 (self-audit compliance)** Does the sweep that walks rules.md INCLUDE walking §24 itself against the journal it writes into? In other words, does the latest big table have rows for §24.0, §24.0a-i, §24.1-§24.18 (incl. §24.13.1-4 and §24.13.3a-d) — each one PASS-cited or FINDING'd against the journal file itself?
