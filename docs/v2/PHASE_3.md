...
| [PHASE_3_AUTH_CORE.md](PHASE_3_AUTH_CORE.md) | **Auth Core domain design keep** — principals/scopes, user+org lifecycles, multi-org/trees+proxy, membership, invites, security policy, credentials, platform sub entitlements, IdP/SCIM, sessions elevate, dual audit; **L9–L163**. Findings remediated; keep open for O23/O24. Read before A2 PLAN. |
| [PHASE_3_AUTH_CORE_DESIGN_AUDIT.md](PHASE_3_AUTH_CORE_DESIGN_AUDIT.md) | **Hostile design audit** of Auth Core keep — C/H/M + Qs **remediated** into keep. Re-audit / Fable; then O23/O24 before PLAN. |
