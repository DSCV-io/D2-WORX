...
**Status**: 🔄 In progress — KeyCustodian (K1) shipped; **T1** (TS caching twin / 0028) PLAN locked on `n/ts-caching`; A1 (Edge host shell) remains next on the auth host spine (parallel with T1).
