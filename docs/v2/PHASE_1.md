...
| Go/no-go user-review gate (between 0008 and 0009)                                                                                                                                  | 🔄 In progress        | 0008 commits queued for user review (`6920c1be` daily-sweep close-out + `30bdad4f` 0008 audit cleanup + this PHASE_1.md sync + deliverable doc snapshot + 13 schema files + 1 `rules.md` §24 augmentation). Explicit user approval gates 0009 EXECUTE start.                                                                                                                                                                                                                                                            |
| EXECUTE — Deliverable 0009-geo-libs (consumes 0008's specs)                                                                                                                        | ☐ Queued (after 0008) | Step ordering below (per Decision 18) — Step 0 Branch checkout `n/geo-libs` off clean `nova` after 0008 ships                                                                                                                                                                                                                                                                                                                                                                                                           |
| EXECUTE — 0009 Step 1: `D2.Shared.Time` + `@d2/time`                                                                                                                               | ☐ Not started         | NodaTime wrapper, IClock, EF value converters; Temporal API wrapper TS-side                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| EXECUTE — 0009 Step 2: `D2.Shared.Geo.Abstractions` + `@d2/geo-abstractions`                                                                                                       | ☐ Not started         | Types + lookup interfaces + DeprecationInfo (zero deps)                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| EXECUTE — 0009 Step 3: Spec consumption + .NET SourceGen + TS emitter                                                                                                              | ☐ Not started         | Consume 0008-produced specs (countries / subdivisions / currencies / languages / locales / timezones spec.json)                                                                                                                                                                                                                                                                                                                                                                                                         |
| EXECUTE — 0009 Step 4: `D2.Shared.Geo.Default` + `@d2/geo-default`                                                                                                                 | ☐ Not started         | Codegen'd lookups + sub-exports for tree-shake                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| EXECUTE — 0009 Step 5: `D2.Shared.Location` + `@d2/location`                                                                                                                       | ☐ Not started         | 3 VOs + composition function + `IPostalCodeValidator`                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| EXECUTE — 0009 Step 6: Cross-cutting (DROP `Region` field from IRequestContext spec — entire field removed, no rename; PATTERNS.md + new TIMESTAMPS.md; rules.md predicate drafts) | ☐ Not started         | Doc updates + spec drop                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| EXECUTE — 0009 Step 7: Final-review (K=12 + Aggregator per process.md §3a-c) + Deliverable Completeness Checklist                                                                  | ☐ Not started         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| SHIP — 0008-geo-data-pipeline                                                                                                                                                      | 🔄 In progress        | Deliverable doc snapshot at [`docs/dev/deliverables/0008-geo-data-pipeline.md`](../dev/deliverables/0008-geo-data-pipeline.md) ready. Squash-merge `n/geo-data-pipeline` → `nova` queued behind user REVIEW. **Process lesson captured**: `rules.md` §24 augmented with tamper-evident Fixer dispatch protocol after the F-3 false-closure pattern (TWO consecutive Fixers self-reported running `pnpm tier-2:build` without the regen actually landing).                                                               |
| SHIP — 0009-geo-libs                                                                                                                                                               | ☐ Not started         | Squash merge `n/geo-libs` → `nova`; apply **14 approved rules.md predicates** (§1.22-§1.30 + §1.31 strengthened + §1.32 new + §13.5 + §13.6 new + §7.x); snapshot README to `docs/dev/deliverables/0009-geo-libs.md`; update V2.md §4 Phase 1 row to ✅                                                                                                                                                                                                                                                                 |
