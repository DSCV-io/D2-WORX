...
public static class EnumerableExtensions
{
    ...
    {
        /// <summary>
        /// Determines if an enumerable is "truthy" (i.e., not null and contains at least one
        /// element).
        /// </summary>
        ///
        /// <returns>
        ...
        ///
        /// <returns>
        /// True if the enumerable is null or contains no elements; otherwise, false.
        /// </returns>
        public bool Falsey() => !Truthy(enumerable);
        ...
        /// The chosen enumerable behavior if the enumerable is null or empty before or after
        /// cleaning.
        /// </param>
            ...
            CleanValueNullBehavior valueNullBehavior = CleanValueNullBehavior.RemoveNulls)
        {
            ...
            // Iterate through each value, clean it, and handle nulls based on the specified
            // behavior.
    ...
    public enum CleanValueNullBehavior
    {
        ...
        /// <summary>
        /// Throw an exception if a cleaned value is null.
        /// </summary>
        ThrowOnNull,
    }
}
