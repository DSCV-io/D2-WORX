...
{
    /// <summary>
    /// Gets the first line of the street address, typically containing the primary street number and
    /// name.
    /// </summary>
    /// <example>
    /// 123 Main St.
    ...
    /// <summary>
    /// Gets the second line of the street address, often used for building, apartment, suite, unit.
    /// </summary>
    /// <example>
    /// Building B.
    /// </example>
    ...
    /// <summary>
    /// Gets the third line of the street address, sometimes used for additional information like
