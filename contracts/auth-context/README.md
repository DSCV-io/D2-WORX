...
- **.NET** — [`server/shared/dotnet/context/source-gen/`](../../server/shared/dotnet/context/source-gen/README.md) (Roslyn source-gen → `PropagatedContext` + serializer in `D2.Shared.Context.Abstractions`; the same generator also emits the request-context layer)
