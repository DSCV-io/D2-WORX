...
- **.NET** — [`server/shared/dotnet/auth/error-codes-source-gen/`](../../server/shared/dotnet/auth/error-codes-source-gen/README.md) (Roslyn source-gen → `AuthErrorCodes` constants + `AuthFailures` typed `D2Result` factories in `D2.Shared.Auth.Core`)
