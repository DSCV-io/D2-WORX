...
- **.NET** — [`server/shared/dotnet/encryption/frame-source-gen/`](../../server/shared/dotnet/encryption/frame-source-gen/README.md) (Roslyn source-gen → `SealedFrameLayout` byte-offset + length constants in `D2.Shared.Encryption`)
