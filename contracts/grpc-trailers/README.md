...
- **.NET** — [`server/shared/dotnet/result/grpc-trailers-source-gen/`](../../server/shared/dotnet/result/grpc-trailers-source-gen/README.md) (Roslyn source-gen → `D2GrpcTrailers` constants in `D2.Shared.Auth.Grpc`)
